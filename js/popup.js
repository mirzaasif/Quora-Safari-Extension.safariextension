...
{
	hide();
	safari.extension.globalPage.contentWindow.pop_post();
}
...
function onLoad()
{
	...
	result = safari.extension.globalPage.contentWindow.pop_getResult();
	update();
	showRecommendationLink();
	settings = safari.extension.globalPage.contentWindow.pop_getSettings();
...
function changeSettings()
{
	...
	safari.extension.globalPage.contentWindow.pop_saveSettings(settings);	
